...
const htmlTemplete=`
      <section class="infomation-section">
          <div>
              <a href="memLogin.htm"><img src="src/img/logo.png" alt=""></a>
          </div>
          ...
          <div class="box-container">
              <div class="box shadow-20">
                  ...
                  <br><br>
                  <span @click="wOpen('icons.htm')" style="cursor:pointer;"><span class="material-symbols-rounded" style="color:#003399;">rocket_launch</span>icon</span> &nbsp;
                  ...
                  <span @click="href('1.index.html')" style="cursor:pointer;"><span class="material-symbols-rounded" style="color:#003399;">corporate_fare</span>Index</span><br>
          ...
          <div>
              ...
              <form>
                  ...
                  <div class="m-size-text bold-text login-button">
                      <p><a href="memList.htm" style="color:white;">
                      <span class="material-symbols-rounded" style="color:#00cccc;">login</span>
                      <span style="vertical-align:-2px;">로그인</span>
                      </a></p>
                  </div>
              </form>
          </div>
