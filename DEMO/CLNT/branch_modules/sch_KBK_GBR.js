const schemas={
  ...
  KBK_GBR_0000111A:{//KGR010S111_당타행이체거래요청
    ...
    instiEntpNo:{key:"instiEntpNo",note:"기관업체번호",type:"cha",max:10,min:10,source:"PIC X(n)",depth:3},
    cmnDvsnBnkCd:{key:"cmnDvsnBnkCd",note:"공통부은행코드",type:"int",max:2,min:2,source:"PIC X(n)",depth:3},
    ...
    trsmtDte:{key:"trsmtDte",note:"전송일자",type:"int",max:8,min:8,source:"PIC X(n)",depth:3},
    trsmtTtm:{key:"trsmtTtm",note:"전송시간",type:"int",max:6,min:6,source:"PIC X(n)",depth:3},
    ...
    drwotAcno:{key:"drwotAcno",note:"출금계좌번호",type:"int",max:20,min:12,source:"PIC X(n)",depth:3},
    drwotAcnPwd:{key:"drwotAcnPwd",note:"출금계좌비밀번호",type:"int",max:36,min:4,source:"PIC X(n)",depth:3},
    mnrcvBnkCd:{key:"mnrcvBnkCd",note:"입금은행코드",type:"int",max:3,min:3,source:"PIC X(n)",depth:3},
    mnrcvAcno:{key:"mnrcvAcno",note:"입금계좌번호",type:"int",max:20,min:10,source:"PIC X(n)",depth:3},
    ...
    fndsChatrDstcd:{key:"fndsChatrDstcd",note:"자금성격구분코드",type:"cha",max:2,min:2,source:"PIC X(n)",depth:3},
    cMSMgtNo:{key:"cMSMgtNo",note:"CMS관리번호",type:"cha",max:16,min:0,source:"PIC X(n)",depth:3}
  },

  ///////////////////////
  KBK_GBR_0000121S:{//KGR020S121_대량이체모계좌출금요청
    MethodComName:{key:"KGR020S121",note:"대량이체모계좌출금요청 (미개발)",type:"div",depth:0},
    ...
    drwotAcno:{key:"drwotAcno",note:"출금계좌번호",type:"int",max:20,min:12,source:"PIC X(n)",depth:3},
    drwotAcnPwd:{key:"drwotAcnPwd",note:"출금계좌비밀번호",type:"int",max:36,min:4,source:"PIC X(n)",depth:3},
    rqstNoitm:{key:"rqstNoitm",note:"총의뢰건수",type:"int",max:11,min:1,source:"PIC 9(n)",depth:3},
    rqstAmt:{key:"rqstAmt",note:"총의뢰금액",type:"int",max:15,min:1,source:"PIC 9(n)",depth:3},
    drwotSumry:{key:"drwotSumry",note:"출금적요",type:"cha",max:22,min:0,source:"PIC X(n)",depth:3},
    rqstrFname:{key:"rqstrFname",note:"의뢰인성명",type:"cha",max:40,min:0,source:"PIC X(n)",depth:3},
  ...
  KBK_GBR_0000141S:{//KGR040S141_계좌거래내역조회
    ...
    acno:{key:"acno",note:"계좌번호",type:"cha",max:20,min:12,source:"PIC X(n)",depth:3},
    inquryStartYmd:{key:"inquryStartYmd",note:"조회시작년월일",type:"int",max:8,min:8,source:"PIC X(n)",depth:3},
    inquryEndYmd:{key:"inquryEndYmd",note:"조회종료년월일",type:"int",max:8,min:8,source:"PIC X(n)",depth:3},
    nextHistExstYn:{key:"nextHistExstYn",note:"다음내역존재여부",type:"cha",max:1,min:0,source:"PIC X(n)",depth:3},
    nextTranYmd:{key:"nextTranYmd",note:"다음거래년월일",type:"int",max:8,min:0,source:"PIC X(n)",depth:3},
    nextTranSerno:{key:"nextTranSerno",note:"다음거래일련번호",type:"cha",max:5,min:5,source:"PIC X(n)",depth:3},
    inquryRsultTotalCnt:{key:"inquryRsultTotalCnt",note:"조회결과총개수",type:"int",max:5,min:0,source:"PIC X(n)",depth:3},
    inquryRsultCnt:{key:"inquryRsultCnt",note:"조회결과개수",type:"int",max:2,min:1,source:"Integer",depth:3},
    ...
    tranDte:{key:"tranDte",note:"거래일자",type:"int",max:8,min:0,source:"PIC X(n)",depth:4},
    tranTtm:{key:"tranTtm",note:"거래시간",type:"int",max:6,min:0,source:"PIC X(n)",depth:4},
    ...
    drwotzAmt:{key:"drwotzAmt",note:"출금금액",type:"int",max:14,min:0,source:"PIC X(n)",depth:4},
    drwotAmtMnrcvBnkCd:{key:"drwotAmtMnrcvBnkCd",note:"출금금액입금은행코드",type:"cha",max:3,min:0,source:"PIC X(n)",depth:4},
    drwotAmtMnrcvAcno:{key:"drwotAmtMnrcvAcno",note:"int",type:"cha",max:20,min:0,source:"PIC X(n)",depth:4},
    drwotAmtMnrcvDpstrName:{key:"drwotAmtMnrcvDpstrName",note:"출금금액입금예금주명",type:"cha",max:40,min:0,source:"PIC X(n)",depth:4},
    mrvamt:{key:"mrvamt",note:"입금금액",type:"int",max:14,min:0,source:"PIC X(n)",depth:4},
  ...
  KBK_GBR_0000241S:{//KGR040S241_계좌잔액조회
    ...
    idiviDvsnBnkCd:{key:"idiviDvsnBnkCd",note:"개별부은행코드",type:"int",max:3,min:3,source:"PIC X(n)",depth:3},
    acno:{key:"acno",note:"계좌번호",type:"int",max:20,min:0,source:"PIC X(n)",depth:3},
  ...
  KBK_GBR_0000341A:{//KGR040S341_예금주성명조회요청
    ...
    splizTrsmtNotms:{key:"splizTrsmtNotms",note:"전문전송횟수",type:"int",max:1,min:1,source:"PIC 9(n)",depth:3},
    intnlApiTelgmNo:{key:"intnlApiTelgmNo",note:"내부API전문번호",type:"cha",max:8,min:8,source:"PIC X(n)",depth:3},
    trsmtDte:{key:"trsmtDte",note:"int",type:"cha",max:8,min:8,source:"PIC X(n)",depth:3},
    trsmtTtm:{key:"trsmtTtm",note:"int",type:"cha",max:6,min:6,source:"PIC X(n)",depth:3},
    rspnsCd:{key:"rspnsCd",note:"응답코드",type:"cha",max:4,min:0,source:"PIC X(n)",depth:3},
    entpScop:{key:"entpScop",note:"업체영역",type:"cha",max:11,min:0,source:"PIC X(n)",depth:3},
    bnkScop:{key:"bnkScop",note:"은행영역",type:"cha",max:10,min:0,source:"PIC X(n)",depth:3},
    cmnDvsnSpareScop:{key:"cmnDvsnSpareScop",note:"공통부예비영역",type:"cha",max:100,min:0,source:"PIC X(n)",depth:3},
    ...
    mnrcvBnkCd:{key:"mnrcvBnkCd",note:"입금은행코드",type:"int",max:3,min:0,source:"PIC X(n)",depth:3},
    mnrcvAcno:{key:"mnrcvAcno",note:"입금계좌번호",type:"int",max:20,min:0,source:"PIC X(n)",depth:3},
    ...
    inhabBzno:{key:"inhabBzno",note:"주민사업자번호",type:"int",max:13,min:0,source:"PIC X(n)",depth:3},
  ...
  KBK_GBR_0000541S:{//KGR040S541_이체처리결과조회
    MethodComName:{key:"KGR040S541",note:"이체처리결과조회 (미개발)",type:"div",depth:0},
