...
ut.rdCharMaker=(strLen=5,chars='0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz')=>{
  let rdStr='';
...
ut.GQtrust=(query)=>{//get query를 통해 들어온 사용자 입력을 모두 HTML 엔티티로 변경한다.
  let qrys={};
