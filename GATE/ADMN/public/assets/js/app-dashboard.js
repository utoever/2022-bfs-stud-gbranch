  ...
  App.dashboard = function( ){
    ...
    function radar_chart(){
      ...
      var color2 = tinycolor( App.color.alt4 ).lighten( 6.5 );
			...
			var ctx = document.getElementById("radar-chart1");
			...
			var data = {
			  ...
			  datasets: [
			    {
            label: "Second Year",
            backgroundColor: color1.setAlpha(.5).toString(),
            borderColor: color1.setAlpha(.8).toString(),
            borderWidth: 2,
			      pointBackgroundColor: color1.setAlpha(.8).toString(),
			      data: [28, 48, 40, 19, 96, 27, 100]
			    },
			    {
            label: "First Year",
            backgroundColor: color2.setAlpha(.5).toString(),
            borderColor: color2.setAlpha(.8).toString(),
            borderWidth: 2,
			      pointBackgroundColor: color2.setAlpha(.8).toString(),
      ...
      var options = {
        ...
        scale: {
          ...
          gridLines: {
            color: color2.setAlpha(.4).toString()
          }
        }
      }
